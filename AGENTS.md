...
3. [docs/roadmap.md](docs/roadmap.md) for current iteration scope, future-only work, and repo follow-up backlog.
...
- [docs/roadmap.md](docs/roadmap.md): Phase 1 scope, future iterations that must stay documented-only for now, and tracked repo follow-up work.
...
- Commands in the updated docs use `npm` because `package-lock.json` is committed. `package.json` still declares `pnpm`; that mismatch is tracked in [docs/roadmap.md](docs/roadmap.md).
